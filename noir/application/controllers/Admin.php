...
class Admin extends CI_Controller
{
    ...
    public function changeAccess()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-dark text-justify" role="alert">Access Changed !</div>');
    }

    public function list_clothing()
    {
        $data['title'] = 'Clothing';
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();
        $data['clothing'] = $this->model_barang_clothing->tampil_data()->result();
        ...
        $this->load->view('list_clothing/list_clothing', $data);
    }
}
