                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <table class="table ">
                            <tr>
                                <td>Product Name</td>
                                <td><strong><?= $acc->nama_brg ?></strong></td>
                            </tr>
                            <tr>
                                <td>Description</td>
                                <td><strong><?= $acc->keterangan ?></strong></td>
                            </tr>
                            <tr>
                                <td>Category</td>
                                <td><strong><?= $acc->kategori ?></strong></td>
                            </tr>
                            <tr>
                                <td>Stock</td>
                                <td><strong><?= $acc->stok ?></strong></td>
                            </tr>
                            <tr>
                                <td>Price</td>
                                <td>
                                    <strong>
                                        <div class="btn btn-sm btn-secondary">IDR : <?= number_format($acc->harga, 0, ',', '.')  ?></div>
                                    </strong>
                                </td>
                            </tr>
                        </table>
                        <?= anchor('dashboard/tambah_ke_keranjang_accessories/' . $acc->id_brg, '<div class="btn btn-dark">Add to Cart</div>'); ?>
                        <?= anchor('accessories/list_accessories/', '<div class="btn btn-danger">Back</div>'); ?><br><br>
